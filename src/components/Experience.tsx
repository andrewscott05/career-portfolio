...
export function Experience() {
  return (
    <AnimatedSection id="experience" className="py-[120px] sm:py-[160px] px-6 sm:px-8 md:px-12 lg:px-16">
      <div className="max-w-[1200px] mx-auto w-full">
        <div className="max-w-2xl">
          <h2 className="section-label mb-14">Experience</h2>
          <div className="relative">
            ...
            <motion.div
              ...
              className="relative pl-10 mt-10 pt-6 border-t border-[var(--color-border-subtle)]"
            >
              <span
