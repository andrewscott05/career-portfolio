...
export const experience: ExperienceItem[] = [
  {
    ...
    bullets: [
      ...
      'AI agent roadmap: 20K+ status tasks/mo and 5K+ document-collection tasks/mo automated, expanding into sourcing, scheduling, and inquiry reduction (7.5K+ monthly support calls)',
      'Automated pricing GTM: drove revenue from $180M to $300M+ annually, with $227M from automation contributing ~10% of total company revenue',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Built an automated quality-control and imaging process, lifting cycle time 20%',
      'Standardized operating procedures across 100+ staff, lifting output 30%',
      'As Program Manager: ran asset-management services for the largest client, covering 90K+ IT assets and $6M+ annual revenue',
    ],
  },
  {
